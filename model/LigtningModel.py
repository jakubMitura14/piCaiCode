...
class Model(pl.LightningModule):
    ...
    ,trial
        ...
        self.postProcess=monai.transforms.Compose([EnsureType(), monai.transforms.Activations(sigmoid=True), AsDiscrete(threshold_values=True)])#, monai.transforms.KeepLargestConnectedComponent()
