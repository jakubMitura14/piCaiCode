...
class Model(pl.LightningModule):
    ...
    ,trial
        ...
        self.postProcess=monai.transforms.Compose([EnsureType(), monai.transforms.Activations(sigmoid=True),monai.transforms.ForegroundMask(), AsDiscrete(to_onehot=2)])#, monai.transforms.KeepLargestConnectedComponent()
