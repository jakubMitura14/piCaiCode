...
"models":[getVNet,getSegResNet ],# getVNet,getSegResNet,getSwinUNETR
...
study = optuna.create_study(
        ...
        ,storage="mysql://root@127.0.0.1:3306/picai_hp_33"
        , load_if_exists=True
        #,storage="mysql://root:pwd@127.0.0.1:88/picai_hp_33"
        )
