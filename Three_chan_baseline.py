...
def mainTrain(trial,df,experiment_name,dummyDict,num_workers,cpu_num ,default_root_dir,checkpoint_dir,options,num_cpus_per_worker):
    ...
    ,RandomGhosting_prob
    ,RandomSpike_prob
    ,RandomBiasField_prob,regression_channels,num_workers,cpu_num ,default_root_dir,checkpoint_dir,trial.suggest_float("lr", 1e-5, 1e-4),num_cpus_per_worker,trial)
